...
#---------------------------
from system.server.serverDANN_backup import serverDANN
#---------------------------
...
def run(args):
    ...
    if args.algorithm == "GHDR":
        ...
        if model_str == "cnn1D":
            ...
            args.model = model.conv_DANN2(data_dim,args.conv_init,args.gru_init, args.linear_init).to(args.device)
